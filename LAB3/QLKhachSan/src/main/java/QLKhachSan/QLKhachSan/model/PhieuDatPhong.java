...
public class PhieuDatPhong {
    ...
    @Id
    @Column(name = "SoPhieuDat", length = 30)
    private String soPhieuDat;

    @Column(name = "MaKhach", nullable = false, length = 20)
    private String maKhach;

    @Column(name = "MaNVLeTan", nullable = false, length = 20)
    ...
    @Column(name = "KenhDat", nullable = false, length = 20)
